...
namespace React
{
	...
	public class Consumable : Blocking<AcquireConsumable>, IConsumable
	{
        ...
        private int _count;
        /// <summary>
        /// The wait queue used to block <see cref="AcquireConsumable"/> desTasks.
        /// </summary>
        ...
        /// <summary>
        /// Resume as many blocked <see cref="DesTask"/>s as there are available
        ...
        /// </summary>
        /// <param name="task">
        /// The <see cref="AcquireConsumable"/> DesTask that has requested one
