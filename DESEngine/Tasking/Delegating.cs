...
{
	/// <summary>
	/// Delegate that handles DesTask processing on behalf of a
	...
	/// Returning <b>true</b> will unblock any <see cref="DesTask"/> instances
	/// waiting on the completion of <paramref name="task"/>.
	/// </remarks>
    /// <param name="task">
    /// The invoking <see cref="Delegating"/> DesTask.
    /// </param>
	...
	/// <summary>
	/// A <see cref="DesTask"/> that delegates processing to an
	/// <see cref="DelegatingTaskHandler"/>.
	/// </summary>
	public class Delegating : DesTask
	{
		/// <summary>
		/// The callback that does the actual DesTask processing.
		/// </summary>
		private DelegatingTaskHandler _handler;

		/// <summary>
		/// Create a new <see cref="Delegating"/> DesTask that has no
		/// <see cref="Handler"/>.
		/// </summary>
		/// <remarks>
		/// A handler must be set or this DesTask will do nothing.
		/// </remarks>
		/// <param name="sim">
		...
		/// <summary>
		/// Create a new <see cref="Delegating"/> DesTask that delegates DesTask
		...
		/// DesTask processing functionality.
		/// </param>
		...
		/// <summary>
		/// Gets or sets the desTasks <see cref="DelegatingTaskHandler"/> callback
		/// that handles the actual DesTask processing functionality.
		/// </summary>
		/// <exception cref="ArgumentNullException">
		/// If an attempt is made to set the value to <see langword="null"/>.
		/// </exception>
		/// <value>
		/// The <see cref="Delegating"/> DesTask's callback that handles the
		/// actual DesTask processing functionality.
		/// </value>
		...
		/// <summary>
		/// Performs DesTask processing by invoking the associated
		/// <see cref="DelegatingTaskHandler"/>.
		/// </summary>
		/// <remarks>
		...
		/// </remarks>
		/// <param name="activator">
		/// The object that activated this <see cref="Delegating"/> DesTask.
		/// </param>
		/// <param name="data">
		/// Optional data for the <see cref="Delegating"/> DesTask.
		/// </param>
