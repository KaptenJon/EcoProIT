...
namespace React
{
    ...
    /// capacity.  <see cref="DesTask"/>s that use the <see cref="IBoundedBuffer"/>
    ...
    /// </para>
    /// <para>
    /// <see cref="DesTask"/>s that are acting as producers use <see cref="Put"/>
    ...
    /// the <see cref="DesTask"/> returned by <see cref="Put"/> will block until
    /// such time as the buffer has room for another item.
    /// </para>
    /// <para>
    /// <see cref="DesTask"/>s that are acting as consumers use <see cref="Get"/>
    /// to attempt to remove an item from the buffer.  If the buffer is not
    /// empty an item is immediately removed; otherwise the <see cref="DesTask"/>
    ...
    public interface IBoundedBuffer
    {
        ...
        /// </returns>
        [BlockingMethod]
        DesTask Put(DesTask producer, object item);
    }
}
