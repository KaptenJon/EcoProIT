...
namespace React
{
	...
	/// <remarks>
    /// <para>
    /// Methods that have this attribute must return a <see cref="DesTask"/>
    /// instance.  This attribute is used solely to document methods that
    /// return a <see cref="DesTask"/> that must be blocked upon.  The returned
    /// <see cref="DesTask"/> will perform some action on behalf of another
    /// <see cref="DesTask"/>.
    /// </para>
    /// <para>
    ...
    /// </para>
    /// <para>
    /// In the above case, the <see cref="IResource.Acquire(DesTask)"/> method is
    /// a blocking method.  The <see cref="DesTask"/> it returns is blocked upon
