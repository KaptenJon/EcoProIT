...
namespace React
{
	...
	public sealed class BackClockingException : SchedulingException
	{
		...
		public BackClockingException(Simulation sim) : this (sim, 0L)
		{
		}
        ...
        /// </param>
		public BackClockingException(Simulation sim, ulong time)
			: base(sim)
		{
			_schdTime = time;
		}
        ...
        /// The message that describes the error.
        /// </param>
        public BackClockingException(Simulation sim, ulong time, string message)
            :
			base(sim, message)
		{
			_schdTime = time;
