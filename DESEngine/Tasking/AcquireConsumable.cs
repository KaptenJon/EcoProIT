...
{
    /// <summary>
    /// A <see cref="DesTask"/> used to acquire one or more consumable items
    ...
    /// methods which will return the appropriate <see cref="DesTask"/> for
    /// acquiring consumable items on behalf of a client <see cref="DesTask"/>.
    /// </para>
    /// <para>
    ...
    /// </para>
    /// </remarks>
    public class AcquireConsumable : ProxyDesTask<Consumable>
    {
        /// <summary>
        ...
        /// <summary>
        /// Set to <b>true</b> if the <see cref="AcquireConsumable"/> DesTask
        ...
        /// <overloads>
        /// Create and initialize an AcquireConsumable DesTask.
        /// </overloads>
        /// <summary>
        /// Create a new <see cref="AcquireConsumable"/> DesTask that will acquire
        ...
        /// <see cref="AcquireConsumable"/> DesTask will wait for a resource
        /// indefinitely.
        /// </remarks>
        /// <value>
