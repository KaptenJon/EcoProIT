...
namespace React.Monitoring
{
    ...
    public abstract class TimeWeightedStatistic : Statistic
    {
        ...
        /// </summary>
        /// <remarks>
        /// This method simply invokes <see cref="Observe(double,ulong)"/>,
        ...
        /// </param>
        public virtual void Observe(double value, ulong time)
        {
        ...
        /// <see cref="Observe(double,ulong)"/>.  The time is obtained from
        ...
        /// </param>
        private void ObserveObject(object value, ulong time)
        {
            if (value == null)
            {
