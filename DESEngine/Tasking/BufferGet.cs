...
{
    /// <summary>
    /// A <see cref="DesTask"/> used to remove an item from a
    ...
    /// </para>
    /// </remarks>
    public class BufferGet : ProxyDesTask<BoundedBuffer>
    {
        /// <summary>
        /// Create a <see cref="BufferGet"/> DesTask that will remove an item
