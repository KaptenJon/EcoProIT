...
{
    /// <summary>
    /// A <see cref="DesTask"/> used to add an item to a
    ...
    /// method which will return the appropriate <see cref="DesTask"/> for adding
    ...
    /// </para>
    /// </remarks>
    public class BufferPut : ProxyDesTask<BoundedBuffer>
    {
        /// <summary>
        ...
        /// <overloads>Create and initialize a BufferPut DesTask.</overloads>
        /// <summary>
        /// Create a <see cref="BufferPut"/> DesTask that will add an item to
        ...
        /// <summary>
        /// Create a <see cref="BufferPut"/> DesTask that will add the given
        ...
        /// The object that activated this <see cref="BufferPut"/> DesTask.
        /// </param>
        /// <param name="data">
        /// Optional data for the <see cref="BufferPut"/> DesTask.  This will
