...
namespace EcoProIT.UI.DataLayer
{
    ...
    public enum SIUnits
    {
        kg, L, Piece, kW, kWh, MJ, MW,  m, km,  ha, m2, year, h, s, kBq, m3,
    }
    [Serializable]
    public class Consumable:IComparable<Consumable>,IEquatable<Consumable>
    {
        ...
        public string Name
        {
            get { return Product==null? _name:Product.ProductName; }
            set { _name = value; }
        }
        ...
        public string ecospoldId { get; set; }
    ...
    {
        private Consumable _consumable = ResourceDefinitionModel.ConsumeblesAndProducts.FirstOrDefault();
