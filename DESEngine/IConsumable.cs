...
namespace React
{
    ...
    /// <em>pool</em> of consumables that may be acquired by <see cref="DesTask"/>s
    ...
    /// <see cref="DesTask"/>s.  When all consumable units have been dispensed,
    /// the next <see cref="DesTask"/> to call one of the <b>Acquire</b> methods
    ...
    /// to serve <see cref="DesTask"/> requests.
    /// </para>
    /// <para>
    ...
    public interface IConsumable
    {
        ...
        /// The <see cref="DesTask"/> that is requesting to acquire a consumable
        /// unit from the pool.
        /// </param>
        /// <returns>
        /// The <see cref="DesTask"/> which will acquire a consumable unit from
        ...
        /// </summary>
        /// <param name="requestor">
        /// The <see cref="DesTask"/> that is requesting one or more consumable
        /// units  from the pool.
        /// </param>
        /// <param name="quantity">
        ...
        /// </param>
        /// <returns>
        /// The <see cref="DesTask"/> which will acquire the given number of
        /// consumable units from the pool on behalf of
        /// <paramref name="requestor"/>.
        /// </returns>
        [BlockingMethod]
        DesTask Acquire(DesTask requestor, int quantity);

        /// <summary>
        /// Adds consumable units to the <see cref="IConsumable"/>.
        /// </summary>
        /// <param name="desTask">
        /// The <see cref="DesTask"/> requesting the <see cref="IConsumable"/>
        /// be re-supplied.
        /// </param>
        /// <param name="quantity">
        ...
        /// </param>
        /// <returns>
        /// The <see cref="DesTask"/> that will re-supply the
        /// <see cref="IConsumable"/> on behalf of <paramref name="desTask"/>.
        /// </returns>
        [BlockingMethod]
        DesTask Resupply(DesTask desTask, int quantity);
    }
}
