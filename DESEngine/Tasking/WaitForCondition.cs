...
{
    /// <summary>
    /// A <see cref="DesTask"/> used to wait for a <see cref="Condition"/> to
    ...
    /// </para>
    /// </remarks>
    public class WaitForCondition : ProxyDesTask<Condition>
    {
        /// <summary>
        /// Create a new <see cref="WaitForCondition"/> DesTask that will wait on
        ...
        /// The object that activated this <see cref="WaitForCondition"/> DesTask.
        /// </param>
