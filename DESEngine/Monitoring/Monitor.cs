    ...
    public abstract class Monitor
    {
        ...
        private static PropertyInfo FindProperty(Type type, string propertyName)
        {
            ...
            MemberInfo [] props = type.FindMembers(MemberTypes.Property,
                ...
                Type.FilterNameIgnoreCase, propertyName);
            ...
            PropertyInfo propinfo)
        {
            ...
            Attribute attr = Attribute.GetCustomAttribute(propinfo,
                typeof(MonitorUsingAttribute));
            ...
            MemberInfo[] evts = type.FindMembers(MemberTypes.Event,
                BindingFlags.Instance | BindingFlags.Public,
                Type.FilterName, evtName);
